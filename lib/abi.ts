import { Abi } from 'viem'; // Importe Abi do viem para tipagem

export const babyCoinTokenAbi: Abi = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "function",
    "name": "proposeTransferToExchange",
    "inputs": [
      {
        "name": "amount",
        "type": "uint256",
...
export const babyCoinExchangeAbi: Abi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract BabyCoinToken"
      }
    ],
    "stateMutability": "view"
  },
